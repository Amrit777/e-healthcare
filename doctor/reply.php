...
?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form action="savereply.php?aid=<?php echo $aid;?>" method="post">
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="row" style="padding:15px;">
                            ...
                            <div class="col-lg-10">
							<?php
							$p=mysqli_query($con,"select * from patient where patient_id='".$patient_id."'");
							$pp=mysqli_fetch_array($p);
							
							?>
							<input type="text" class="disabled form-control" disabled=""
							value="<?php echo $pp['patient_name'];?>"/></div>
                        </div>
                        <div class="row" style="padding:15px;">
                        ...
                        <div class="row" style="padding:15px;">
                            ...
                            <div class="col-lg-10"><textarea  style="resize: vertical;max-height: 100px;min-height: 50px;" class="form-control" name="reply"></textarea></div>
                        </div>
                        <div class="row" style="padding:15px;">
                            <input type='submit' class='btn-custom btn btn-block' style="background-color: #245580;color:white">
                        </div>
                    </div>
                </div>
                </form>
